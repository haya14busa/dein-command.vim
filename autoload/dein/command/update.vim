"=============================================================================
" FILE: autoload/dein/command/update.vim
" AUTHOR: haya14busa
" License: MIT license
"=============================================================================
...
function! s:parser() abort
  ...
  \   'plugin', 'a plugin to be updated (e.g. dein.vim)',
  \   {
...
function! dein#command#update#command(bang, range, args) abort
  let parser = s:parser()
  ...
  return dein#update(plugin)
endfunction

function! dein#command#update#complete(arglead, cmdline, cursorpos) abort
