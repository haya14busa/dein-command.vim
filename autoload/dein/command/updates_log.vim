"=============================================================================
" FILE: autoload/dein/command/updates_log.vim
" AUTHOR: haya14busa
" License: MIT license
"=============================================================================
...
function! dein#command#updates_log#command(bang, range, args) abort
  let parser = s:parser()
...
function! dein#command#updates_log#complete(arglead, cmdline, cursorpos) abort
