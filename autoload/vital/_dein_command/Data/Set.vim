...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_dein_command#Data#Set#import() abort
  ...
  execute join(['function! vital#_dein_command#Data#Set#import() abort', printf("return map({'set': '', 'frozenset': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
